<template>
  <div>
    <div @click="createDialog = true" id="Plus_Item">
      <div id="Plus_Img">
        <v-icon style="font-size: 5em; color: #ffb319">add</v-icon>
      </div>
      <div id="Plus_Name">앨범 만들기</div>
    </div>
    <div class="Diary_Item">
      <div class="Diary_Img"></div>
      <div class="Diary_Name">앨범 이름 어쩌구</div>
    </div>
    <div class="Diary_Item">
      <div class="Diary_Img"></div>
      <div class="Diary_Name">앨범 이름 어쩌구</div>
    ...
    <!-- delete Dialog -->
    <v-dialog v-model="createDialog" persistent max-width="286">
      <v-card class="Dialog">
